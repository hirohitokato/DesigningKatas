...
50. 2024/11/29 [[読みやすいコードの書き方]関数(4)](02-practical/28-function_4.md) - 関数の流れ(早期リターン＆関数分割のコツ)
...
45. 2024/02/25 [[読みやすいコードの書き方]依存関係(1)](02-practical/29-dependency_1.md) - 依存関係(結合度)
46. 2025/03/04 [[読みやすいコードの書き方]依存関係(2)](02-practical/30-dependency_2.md) - 依存関係(共通結合,外部結合)
47. 2025/03/11 [[読みやすいコードの書き方]依存関係(3)](02-practical/31-dependency_3.md) - 依存関係(制御結合)
48. 2025/03/18 [[読みやすいコードの書き方]依存関係(4)](02-practical/32-dependency_4.md) - 依存関係(スタンプ結合,データ結合,メッセージ結合)
49. 2025/03/25 [[読みやすいコードの書き方]依存関係(5)](02-practical/33-dependency_5.md) - 依存関係(依存の方向)
50. 2025/04/08 [[読みやすいコードの書き方]依存関係(6)](02-practical/34-dependency_6.md) - 依存関係(依存の重複・暗黙的な依存) 🎉
...
38. 2025/01/31 [[読みやすいコードの書き方]関数(1)](02-practical/25-function_1.md) - 関数の責任
39. 2025/02/21 [[読みやすいコードの書き方]関数(2)](02-practical/26-function_2.md) - 関数の責任 & 関数の流れ(定義指向プログラミング)
40. 2025/02/28 [[読みやすいコードの書き方]関数(3)](02-practical/27-function_3.md) - 関数の流れ(定義指向プログラミング)
41. 2025/03/07 [[読みやすいコードの書き方]関数(4)](02-practical/28-function_4.md) - 関数の流れ(早期リターン＆関数分割のコツ)
42. 2024/03/14 [[読みやすいコードの書き方]依存関係(1)](02-practical/29-dependency_1.md) - 依存関係(結合度)
43. 2025/03/28 [[読みやすいコードの書き方]依存関係(2)](02-practical/30-dependency_2.md) - 依存関係(共通結合,外部結合)
44. 2025/04/11 [[読みやすいコードの書き方]依存関係(3)](02-practical/31-dependency_3.md) - 依存関係(制御結合)
45. 2025/04/18 [[読みやすいコードの書き方]依存関係(4)](02-practical/32-dependency_4.md) - 依存関係(スタンプ結合,データ結合,メッセージ結合)
46. 2025/04/25 [[読みやすいコードの書き方]依存関係(5)](02-practical/33-dependency_5.md) - 依存関係(依存の方向)
47. 2025/05/02 [[読みやすいコードの書き方]依存関係(6)](02-practical/34-dependency_6.md) - 依存関係(依存の重複・暗黙的な依存) 🎉
...
18. 2025/02/26 [[読みやすいコードの書き方]依存関係(1)](02-practical/29-dependency_1.md) - 依存関係(結合度)
19. 2025/03/05 [[読みやすいコードの書き方]依存関係(2)](02-practical/30-dependency_2.md) - 依存関係(共通結合,外部結合)
20. 2025/03/12 [[読みやすいコードの書き方]依存関係(3)](02-practical/31-dependency_3.md) - 依存関係(制御結合)
21. 2025/03/19 [[読みやすいコードの書き方]依存関係(4)](02-practical/32-dependency_4.md) - 依存関係(スタンプ結合,データ結合,メッセージ結合)
22. 2025/03/26 [[読みやすいコードの書き方]依存関係(5)](02-practical/33-dependency_5.md) - 依存関係(依存の方向)
23. 2025/04/02 [[読みやすいコードの書き方]依存関係(6)](02-practical/34-dependency_6.md) - 依存関係(依存の重複・暗黙的な依存) 🎉

## その他

1. 2024/09/26 SOLIDとオブジェクト指向プログラミングについて30分で <!-- VP -->
2. 2025/05/27 [プログラミングと英語](02-practical/15.1-naming_45m.md) - 読みやすいコードの書き方 (命名)を45分で <!-- FY25新人研修 -->
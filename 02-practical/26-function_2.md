...
変数をこの２視点で分割できると、なんのために定義するかが明確になってコードが分かりやすくなる。
...
<!-- そもそも、for文やif文は制御構造の表現としてはプリミティブ・原始的すぎる。命名編で述べた適切な名前を処理にも付けてあげられれば、読みやすさや保守性は格段に上がる。 -->
...
次回はメソッドチェーン・リテラルを定義指向プログラミングで解決します

...
<!-- ポリモーフィズムも暗黙な依存関係であることにも注意。オブジェクト指向プログラミングに対応した言語で開発している人だと普通に使っていて読めるコードだけれど、初めてそういうコードを読んだ時に「読みにくい」と思った方は少なからずいると思う。
ポリモーフィズムに馴染んでいる人は、当時の感覚を忘れないでいてほしい。 -->

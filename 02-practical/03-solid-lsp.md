...
<!-- 今回はLSP。SOLIDというオブジェクト指向で設計するときに常に役立つ５大原則のうち、親クラスと子クラスがどういう関係にあれば継承のメリットを最大限活かせるかを示した原則。 -->
...
サブクラスを変えたときに使用している側のコードを書き換えるような処理を書くな
使用している側で特定のサブクラスに限定した処理を書くな
